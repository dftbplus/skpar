...
project = "SKPAR"
copyright = "2013 - 2017, Stanislav Markov"
...
latex_documents = [
    (master_doc, "SKPAR.tex", "SKPAR Documentation", "Stanislav Markov", "manual"),
]
...
man_pages = [(master_doc, "skpar", "SKPAR Documentation", [author], 1)]
