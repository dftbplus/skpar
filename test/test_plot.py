...
class BandstructurePlotTest(unittest.TestCase):
    ...
    def test_plot_bs_2(self):
        ...
        xx1 = bsdata[0]
        yy1 = bsdata[1:]
        jitter = 0.1 * (0.5 - random(yy1.shape))
        yy2 = yy1 + jitter
    ...
    def test_plot_bs_4(self):
        ...
        yy1 = bsdata[1:]
        j = 6
        jitter = 0.1 * (0.5 - random(yy1[:j, :8].shape))
        yy2 = yy1[:j, :8] + jitter
        xx2 = xx1[:8]
        ...
        plot_bs(
            ...
            xticklabels=xtl,
            linelabels=["ref", "model"],
            title="Test 2 bands 2 (different) kpts",
            xlabel=None,
            filename=filename,
        )
        self.assertTrue(os.path.exists(filename))
    ...
    def test_magic_plot_bs_2(self):
        ...
        magic_plot_bs(
            ...
            xticklabels=xtl,
            linelabels=["ref", "model"],
            title="Test magic 2 Eg Eg VB VB CB CB",
            xlabel=None,
        )
        self.assertTrue(os.path.exists(filename))
    ...
    def test_magic_plot_bs_3(self):
        ...
        magic_plot_bs(
            ...
            title="Test magic 3 Eg VB CB Eg VB CB",
            xlabel=None,
        )
        self.assertTrue(os.path.exists(filename))
...
class GenericPlotTaskTest(unittest.TestCase):
    ...
    def test_skparplot(self):
        ...
        get_bandstructure(
            env, database, "test_dftbutils/Si/bs/", model, latticeinfo=latticeinfo
        )
